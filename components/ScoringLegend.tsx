        ...
        <div className="mt-4 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div className="p-2 bg-green-100 rounded border border-green-200 text-green-900">
                <span className="font-semibold">1 pt:</span> Easy (50/50)
              </div>
              <div className="p-2 bg-blue-100 rounded border border-blue-200 text-blue-900">
                <span className="font-semibold">2 pts:</span> Medium (45%)
              </div>
              <div className="p-2 bg-orange-100 rounded border border-orange-200 text-orange-900">
                <span className="font-semibold">3 pts:</span> Hard (25%)
              </div>
              <div className="p-2 bg-red-100 rounded border border-red-200 text-red-900">
