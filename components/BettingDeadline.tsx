...
import { isBettingClosed } from '@/lib/betting-rules'
      ...
      <div className="bg-red-100 border border-red-400 rounded-lg p-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-red-700">Tournament has started. No more bets accepted.</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="bg-amber-50 border border-amber-300 rounded-lg p-4 mb-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-amber-700">Place your bets before tournament starts</p>
        </div>
        <div className="text-right">
          <div className="text-lg font-bold text-amber-900 font-mono">{timeRemaining}</div>
